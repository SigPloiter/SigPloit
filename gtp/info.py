	...
	try:
		while True:
			...
			if choice == 'help' or choice == '?':
				...
				gtpmain.showOptions(gtpmain.config_file,gtpmain.remote_net,gtpmain.listening,gtpmain.verbosity)
				...
				discover_gtp_nodes.main(gtpmain.config_file, gtpmain.remote_net, gtpmain.listening, gtpmain.verbosity)
			elif 'back' in choice:
...
def teidiscover():
	...
	script = "discover_teid_allocation.py"
	print 'teidiscover'
